...
- [Part 2 Summary](#part-2-summary)
  ...
  - [Duo-lipa Style Coding](#duo-lipa-style-coding)
  - [(Cont.) Dictionaries](#cont-dictionaries)
    - [Example](#example)
  ...
  - [Recycling code in Python](#recycling-code-in-python)
  - [Functions and Anonymous Functions are first class in Python](#functions-and-anonymous-functions-are-first-class-in-python)
    - [passing a fucntion to a function](#passing-a-fucntion-to-a-function)
    - [Using `lambda` to define anonymous fucntion](#using-lambda-to-define-anonymous-fucntion)
